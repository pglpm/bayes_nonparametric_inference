...
#'   tasks results as they are generated by foreach looping. See foreach
#'   documentation for details.Default is rbind.
#' @param useOquantiles: Boolean, What does this do?
#' @param parallel: Bool or numeric: whether to use pre-existing parallel
#'   workers, or how many to create and use. If TRUE (default) looks for already
#'   registered parallel backends.
#' @param silent: Boolean, suppress printouts. Set to FALSE.
#' @return ?
